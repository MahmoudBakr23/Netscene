      ...
      <Grid item container direction="column" lg={7}>
        ...
        <Grid item container spacing={2}>
          {data && data?.credits?.cast?.map((c, i) => (
            c.profile_path && (
            <Grid key={i} item xs={4} md={2} component={Link} to={`/actors/${c.id}`} style={{ textDecoration: 'none' }}>
              <img className={classes.castImage} src={`https://image.tmdb.org/t/p/w500/${c.profile_path}`} alt={c.name} />
      ...
      <Box marginTop="5rem" width="100%">
        ...
        </Typography>
        {
          recommendations && recommendations.results.length > 0
            ...
            : <Box display="flex" align="center" justifyContent="center">Sorry nothing was found!</Box>
        }
      </Box>
      <Modal
